...
const DEFAULT_CONTROLS = {
    topology: 'flow-field',
    density: 0.50, luminosity: 0.50, bloom: 0.50, fracture: 0.50, coherence: 0.50,
...
export const RENDER_COMBOS = [
    ...
    { name: 'bloom-lo', ...DEFAULT_CONTROLS, bloom: 0.00 },
    { name: 'bloom-hi', ...DEFAULT_CONTROLS, bloom: 1.00 },
    ...
    { name: 'all-zero', ...DEFAULT_CONTROLS, density: 0, luminosity: 0, bloom: 0, fracture: 0, coherence: 0, hue: 0, spectrum: 0, chroma: 0, scale: 0, division: 0, faceting: 0, flow: 0 },
    { name: 'all-one', ...DEFAULT_CONTROLS, density: 1, luminosity: 1, bloom: 1, fracture: 1, coherence: 1, hue: 1, spectrum: 1, chroma: 1, scale: 1, division: 1, faceting: 1, flow: 1 },
...
export const BATCH_CONFIGS = [
    {
        ...
        structure: { density: 0.3, luminosity: 0.4, bloom: 0.5, fracture: 0.5, coherence: 0.7, scale: 0.4, division: 0.3, faceting: 0.6, flow: 0.5 },
    },
    {
        kind: 'still-v2',
        name: 'Batch Two',
        ...
        structure: { density: 0.7, luminosity: 0.6, bloom: 0.5, fracture: 0.5, coherence: 0.3, scale: 0.6, division: 0.7, faceting: 0.4, flow: 0.5 },
    },
    {
        kind: 'still-v2',
        name: 'Batch Three',
        ...
        structure: { density: 0.1, luminosity: 0.9, bloom: 0.5, fracture: 0.2, coherence: 0.5, scale: 0.8, division: 0.2, faceting: 0.9, flow: 0.5 },
    },
];
