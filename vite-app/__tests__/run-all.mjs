 ...
 *
 * Usage:
 *   node vite-app/__tests__/run-all.mjs          # Run all tests headless
 *   HEADED=1 node vite-app/__tests__/run-all.mjs # Run headed for debugging
 *
 * Prerequisites:
...
const GROUPS = [
    ...
    { file: '../../geometric-interior/__tests__/run-lib-all.mjs', label: 'Library (pure + browser)' },
];
