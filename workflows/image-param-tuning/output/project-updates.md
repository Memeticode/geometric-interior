...
All profiles in `src/core/starter-profiles.json` currently lack a `bloom` field. The exploration workflow (`image-param-exploration`) should determine the ideal bloom value for each profile. Until then, a default of **0.35** is recommended.
