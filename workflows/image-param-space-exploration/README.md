...
Maintain a running document at workflows/image-param-space-exploration/output/session-log.md that serves as a self-contained briefing for resuming after interruptions. The user can point a new session at this file to pick up where we left off.
...
These remain in `sampler-captures/` as reference. New exploration runs produce output in `workflows/image-param-space-exploration/output/`.
...
```
workflows/image-param-space-exploration/
├── README.md                    ← this file
