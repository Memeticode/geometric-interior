...
// Alt-Text Toggle — waiting-open-emphasize (lines extend horizontally + spread vertically)
export const altTextWaitingOpenEmphasizeState = {
  L1: { ...S(5.75, 3.5, 21.25, 3.5), sw: 1.75, da: '100 0', o: 1 },
  L2: { ...S(2.75, 8, 18.25, 8), sw: 1.75, da: '100 0', o: 1 },
  L3: { ...S(2.75, 14.5, 21.25, 14.5), sw: 1.75, da: '100 0', o: 1 },
  L4: { ...S(2.75, 19, 13, 19), sw: 1.75, da: '100 0', o: 1 },
  L5: HP, L6: HP, L7: HP, L8: HP,
  C1: { cx: 5.75, cy: 3.5, r: 0.6, o: 0.5 },
  C2: { cx: 2.75, cy: 8, r: 0.6, o: 0.5 },
  C3: { cx: 2.75, cy: 14.5, r: 0.6, o: 0.5 },
  C4: { cx: 2.75, cy: 19, r: 0.6, o: 0.5 },
  C5: HC, C6: HC, C7: HC,
  P1: { cx: 12, cy: 12, r: 0, o: 0, sw: 0.75 },
};
...
export const fullscreenWaitingOpenState = {
  ...
  L2: { ...S(4, 4, 4, 9), sw: 1.5, da: '100 0', o: 0.85 },
  L3: { ...S(20, 4, 15, 4), sw: 1.5, da: '100 0', o: 0.85 },
  L4: { ...S(20, 4, 20, 9), sw: 1.5, da: '100 0', o: 0.85 },
  L5: { ...S(20, 20, 15, 20), sw: 1.5, da: '100 0', o: 0.85 },
  L6: { ...S(20, 20, 20, 15), sw: 1.5, da: '100 0', o: 0.85 },
  L7: { ...S(4, 20, 9, 20), sw: 1.5, da: '100 0', o: 0.85 },
  L8: { ...S(4, 20, 4, 15), sw: 1.5, da: '100 0', o: 0.85 },
  C1: { cx: 4, cy: 4, r: 0.8, o: 0.5 },
  C2: { cx: 20, cy: 4, r: 0.8, o: 0.5 },
  C3: { cx: 20, cy: 20, r: 0.8, o: 0.5 },
  C4: { cx: 4, cy: 20, r: 0.8, o: 0.5 },
  C5: HC, C6: HC, C7: HC,
  P1: { cx: 12, cy: 12, r: 0, o: 0, sw: 0.75 },
};
...
export const fullscreenWaitingOpenEmphasizeState = {
  L1: { ...S(3, 3, 10, 3), sw: 1.75, da: '100 0', o: 1 },
  L2: { ...S(3, 3, 3, 10), sw: 1.75, da: '100 0', o: 1 },
  L3: { ...S(21, 3, 14, 3), sw: 1.75, da: '100 0', o: 1 },
  L4: { ...S(21, 3, 21, 10), sw: 1.75, da: '100 0', o: 1 },
  L5: { ...S(21, 21, 14, 21), sw: 1.75, da: '100 0', o: 1 },
  L6: { ...S(21, 21, 21, 14), sw: 1.75, da: '100 0', o: 1 },
  L7: { ...S(3, 21, 10, 21), sw: 1.75, da: '100 0', o: 1 },
  L8: { ...S(3, 21, 3, 14), sw: 1.75, da: '100 0', o: 1 },
  C1: { cx: 3, cy: 3, r: 1.1, o: 0.7 },
  C2: { cx: 21, cy: 3, r: 1.1, o: 0.7 },
  C3: { cx: 21, cy: 21, r: 1.1, o: 0.7 },
  C4: { cx: 3, cy: 21, r: 1.1, o: 0.7 },
  C5: HC, C6: HC, C7: HC,
  P1: { cx: 12, cy: 12, r: 0, o: 0, sw: 0.75 },
};
...
export const fullscreenWaitingCloseState = {
  L1: { ...S(9, 9, 4, 9), sw: 1.5, da: '100 0', o: 0.85 },
  L2: { ...S(9, 9, 9, 4), sw: 1.5, da: '100 0', o: 0.85 },
  L3: { ...S(15, 9, 20, 9), sw: 1.5, da: '100 0', o: 0.85 },
  L4: { ...S(15, 9, 15, 4), sw: 1.5, da: '100 0', o: 0.85 },
  L5: { ...S(15, 15, 20, 15), sw: 1.5, da: '100 0', o: 0.85 },
  L6: { ...S(15, 15, 15, 20), sw: 1.5, da: '100 0', o: 0.85 },
  L7: { ...S(9, 15, 4, 15), sw: 1.5, da: '100 0', o: 0.85 },
  L8: { ...S(9, 15, 9, 20), sw: 1.5, da: '100 0', o: 0.85 },
  C1: { cx: 9, cy: 9, r: 0.8, o: 0.5 },
  C2: { cx: 15, cy: 9, r: 0.8, o: 0.5 },
  C3: { cx: 15, cy: 15, r: 0.8, o: 0.5 },
  C4: { cx: 9, cy: 15, r: 0.8, o: 0.5 },
  C5: HC, C6: HC, C7: HC,
  P1: { cx: 12, cy: 12, r: 0, o: 0, sw: 0.75 },
};

// Fullscreen Toggle — waiting-close-emphasize (brackets push slightly inward)
export const fullscreenWaitingCloseEmphasizeState = {
  L1: { ...S(10, 10, 4, 10), sw: 1.75, da: '100 0', o: 1 },
  L2: { ...S(10, 10, 10, 4), sw: 1.75, da: '100 0', o: 1 },
  L3: { ...S(14, 10, 20, 10), sw: 1.75, da: '100 0', o: 1 },
  L4: { ...S(14, 10, 14, 4), sw: 1.75, da: '100 0', o: 1 },
  L5: { ...S(14, 14, 20, 14), sw: 1.75, da: '100 0', o: 1 },
  L6: { ...S(14, 14, 14, 20), sw: 1.75, da: '100 0', o: 1 },
  L7: { ...S(10, 14, 4, 14), sw: 1.75, da: '100 0', o: 1 },
  L8: { ...S(10, 14, 10, 20), sw: 1.75, da: '100 0', o: 1 },
  C1: { cx: 10, cy: 10, r: 1.1, o: 0.7 },
  C2: { cx: 14, cy: 10, r: 1.1, o: 0.7 },
  C3: { cx: 14, cy: 14, r: 1.1, o: 0.7 },
  C4: { cx: 10, cy: 14, r: 1.1, o: 0.7 },
  C5: HC, C6: HC, C7: HC,
  P1: { cx: 12, cy: 12, r: 0, o: 0, sw: 0.75 },
};
