...
The most important interaction partner for bloom is **luminosity**. The 2D luminosity × bloom light space is the primary creative territory this parameter opens. Rather than a mechanical interaction sweep, this is better explored through the `agent-image-param-space-exploration` workflow, which is designed for creative deep-dives into parameter pairs.
