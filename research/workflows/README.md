...
| [tarot-prediction/](tarot-prediction/) | Ritualistic card-by-card generation with random seeds, intuitive configs, and poetic readings | When you want a non-analytical creative process or starting points for the journey workflow |

### Image generation workflows

The dialogue, journey, and tarot-prediction workflows all depend on the shared context library at [shared/image-gen-context.md](shared/image-gen-context.md). Load this into your session before starting any of these workflows — it contains the parameter vocabulary, known recipes, translation guide, and rendering protocol.

### Typical sequence for a new parameter

1. **Implement** the parameter in `geometric-interior/src/core/params.ts`, shaders, materials, HTML
...
|--------|---------|---------|
| `research/scripts/render-single.mjs` | Render one or more configs to PNG (used by dialogue + journey workflows) | On demand |
| `research/scripts/gen-starter-profile-images.mjs` | Portrait thumbnails -> `vite-app/public/static/images/portraits/` | Starter profiles change |
