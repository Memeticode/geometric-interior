 ...
 *
 * Usage:
 *   node geometric-interior/__tests__/run-lib-all.mjs          # headless
 *   HEADED=1 node geometric-interior/__tests__/run-lib-all.mjs # headed for debugging
 *
 * Prerequisites:
...
const libPkg = join(__dirname, '..');
const libPath = join(libPkg, 'dist', 'geometric-interior.js');
